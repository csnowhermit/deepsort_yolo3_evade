...
class YOLO(object):
    def __init__(self):
        self.model_path = 'model_data/trained_weights_final-20200709-all-epoch=50.h5.h5'
        self.anchors_path = 'model_data/yolo_anchors.txt'
        self.classes_path = 'model_data/evade_classes.txt'
        self.score = 0.5
        self.iou = 0.5
